...
class DataUpdatedEventListenerSpec extends Specification {
    ...
    // Define mapper
    def cpsDataUpdatedEventMapper = Mappers.getMapper(CpsDataUpdatedEventMapper.class)
    def eventSchemaMapper = Mappers.getMapper(EventSchemaMapper.class)

    // Define listener under test
    def objectUnderTest = new DataUpdatedEventListener(mockService, cpsDataUpdatedEventMapper, eventSchemaMapper)
