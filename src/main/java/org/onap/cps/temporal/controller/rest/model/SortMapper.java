...
public class SortMapper {
    ...
    private static String SORT_ORDER_SEPARATOR = ",";
    private static String FIELD_DIRECTION_SEPARATOR = ":";
    ...
    public String sortAsString(final Sort sort) {
        return sort.stream()
            .map(sortOrder -> sortOrder.getProperty() + FIELD_DIRECTION_SEPARATOR + sortOrder.getDirection().toString())
