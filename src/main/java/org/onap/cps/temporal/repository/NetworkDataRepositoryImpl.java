...
public class NetworkDataRepositoryImpl implements NetworkDataQueryRespository {
    ...
    private static class SearchCriteriaQueryBuilder {
        ...
        private void addPointInTimeCondition() {
            if (searchCriteria.getPointInTime() != null) {
                queryBuilder.append(" AND created_timestamp <= :pointInTime");
                queryParameters.put("pointInTime", searchCriteria.getPointInTime());
            }
        }
        ...
        private void addObservedAfterCondition() {
            if (searchCriteria.getAfter() != null) {
                ...
                queryParameters.put("after", searchCriteria.getAfter());
            }
        }
        ...
        private void orderBy() {
            ...
            for (final Sort.Order order : sortBy) {
                if (!isFirst) {
                    queryBuilder.append(", ");
                } else {
                    isFirst = false;
                ...
                queryBuilder.append(order.getProperty() + " " + direction);
            }
        }
